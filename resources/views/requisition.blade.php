...
>
  ...
  <div style="max-width: 80rem; margin-left: 20rem; margin-right: auto; padding-left: 1.5rem; padding-right: 1.5rem;">
    <!-- Content -->
    <div style="padding-top: 3rem; padding-bottom: 3rem;">
      <div style="max-width: 64rem; margin-left: auto; margin-right: auto;">
      <div>

           <form method="POST" action="riv" style="background-color: white; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); border-radius: 0.375rem; padding-left: 1rem; padding-right: 1rem; padding-top: 1rem; padding-bottom: 2rem; margin-bottom: 1rem;">
