                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            @auth
                                <a class="nav-link" href="{{ url('/dashboard') }}" style="font-size: 18px; font-weight: bold;">Dashboard</a>
                            </li>
                            @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}" style="font-size: 18px; font-weight: bold;">Login</a>
                            </li>
                            @if (Route::has('register'))

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('register') }}" style="font-size: 18px; font-weight: bold;">Register</a>
                            </li>
                            @endif
                            @endauth
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="heroText d-flex flex-column justify-content-center">
                                ...
                                <p class="mb-4">"The pharmacy management system streamlines inventory control, tracks medication dispensing, and enhances stock management for efficient and accurate pharmaceutical operations."</p>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-5 col-12 mx-auto">
                            <div class="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                                <p class="featured-text"><span class="featured-number">Thank</span> You<br> For Choosing Us</p>
                            </div>
                        </div>
