...
@section('content')
    ...
    <div class="col-md-6">
        ...
        <input type="date" class="form-control" id="date" name="date" required value="{{ date('Y-m-d') }}" readonly>
    </div>
    <div class="col-md-6">
        <label for="quantity_received" class="form-label fw-bold">Quantity Received:</label>
    ...
    <div class="col-md-6">
        ...
        <input type="number" class="form-control" id="quantity_on_hand" name="quantity_on_hand" value="{{ $medicine->quantity_on_hand }}" readonly>
    </div>
    <div class="col-md-6">
