        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/dashboard" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Pharmacy</span>
            </a>
  ...
  <div style="max-width: 64rem; margin: 0 auto;">
    <form method="POST" action="add" style="background-color: white; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); border-radius: 0.375rem; padding-left: 1rem; padding-right: 1rem; padding-top: 1rem; padding-bottom: 2rem; margin-bottom: 1rem;">
      ...
      <div style="background-color: #d1f5d0; margin: 0 auto; max-width: 400px; padding: 20px; border-radius: 10px;">
        <div  style="display: flex; flex-direction: column;">
          <label for="quantity_received" style="font-size: 1.125rem; font-weight: bold; margin-bottom: 0.5rem;">Quantity Received:</label>
          <input type="number" id="quantity_received" name="quantity_received" required  style="border-radius: 8px; padding: 4px;">
        </div>
      </div>
      <br><br>
      <div style="background-color: #d4e9ff; margin: 0 auto; max-width: 400px; padding: 20px; border-radius: 10px;">
        <div  style="display: flex; flex-direction: column;">
          <label for="quantity_issued" style="font-size: 1.125rem; font-weight: bold; margin-bottom: 0.5rem;">Quantity Issued:</label>
          <input type="number" id="quantity_issued" name="quantity_issued" required  style="border-radius: 8px; padding: 4px;">
        </div>
      </div>
      <br><br>
      <div style="background-color: #d1f5d0; margin: 0 auto; max-width: 400px; padding: 20px; border-radius: 10px;">
      ...
      <div style="background-color: #d4e9ff; margin: 0 auto; max-width: 400px; padding: 20px; border-radius: 10px;">
        <div  style="display: flex; flex-direction: column;">
          <label for="losses" style="font-size: 1.125rem; font-weight: bold; margin-bottom: 0.5rem;">Losses:</label>
          <input type="number" id="losses" name="losses" required  style="border-radius: 8px; padding: 4px;">
        </div>
      </div>
      <br><br>
            ...
            <form method="POST" action="{{ route('stock.add', ['id' => $id]) }}">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <input type="date" id="date" name="date" required class="bg-gray-100 text-gray-900 rounded-lg p-2 w-full">
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <input type="number" id="quantity_received" name="quantity_received" required class="bg-gray-100 text-gray-900 rounded-lg p-2 w-full">
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <input type="number" id="quantity_issued" name="quantity_issued" required class="bg-gray-100 text-gray-900 rounded-lg p-2 w-full">
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <input type="number" id="losses" name="losses" required class="bg-gray-100 text-gray-900 rounded-lg p-2 w-full">
                    </div>
                </div>
                ...
                <div class="flex justify-between">
                    <a href="{{ route('stock.card', ['id' => $id]) }}">
                        <div class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-green-600">
                            {{ __("Stock Card") }}
                        </div>
                    </a>
                </div>
