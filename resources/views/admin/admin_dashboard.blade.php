...
@section('content')
    ...
    <body style="margin: 0; padding: 0; overflow: hidden;">
        <div
            ...
            <div class="card"
                style="background-color: #d1f5d0; width: 50%; padding: 20px; box-sizing: border-box; margin-right: 10px; margin-bottom: 10px;">
            ...
            <div class="card"
                style="background-color: #d4e9ff; width: 50%; padding: 20px; box-sizing: border-box; margin-left: 10px; margin-bottom: 10px;">
            ...
            <div class="card"
                style="background-color: #d4e9ff; width: 50%; padding: 30px; box-sizing: border-box; margin-left: 10px; margin-bottom: 10px;">
