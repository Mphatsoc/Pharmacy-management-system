...
<head>
    ...
    <style>
        .card-container {
            ...
            /* Distribute cards evenly across the container */
            padding-left: 1rem;
            padding-right: 1rem;
            padding-top: 9rem;
            padding-bottom: 2rem;
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Components -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text"><span
                                style="font-weight: 700; color: black;">{{ Auth::user()->user }}</span> </span></li>
