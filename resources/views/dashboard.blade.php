        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href="/stock"> <div   class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg"> 
              <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <a href="/notifications"><div  href="#" class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h3 class="text-lg font-medium mb-2">Notifications</h3>
                        <p>Approve/Decline RIVs.</p>
                    </div>
                </div></a>
                <a href="/reports"><div  href="#" class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
