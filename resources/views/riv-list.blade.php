                        ...
                        <table class="table table-bordered border-secondary">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="font-weight: bold; color: black;">Quantity Requested
                                    </th>
                            ...
                            <tbody class="table-group-divider">
                                @foreach ($rivs as $riv)
                                    @if ($riv->department === Auth::user()->department)
                                        <!-- Add this line to check if the riv belongs to the logged-in user -->
                                        <tr>
                                            <td>{{ $riv->date }}</td>
